...
namespace Website.Areas.Admin.Controllers
{
    public class AttributeTypeController : BaseController
    {
        ...
        public IActionResult Index()
        {
            ...
            Module module = _moduleAdminDa.GetTag("AttributeType");
        ...
        {
            ViewBag.Type = "AttributeType";
            SearchModel seach = new ();
            ViewBag.IsExport = false;
            TryUpdateModelAsync(seach);
            seach.keyword = Utility.ValidString(seach.keyword, "", true);
            List<CommonJsonAdmin> listItem = JsonConvert.DeserializeObject<List<CommonJsonAdmin>>(ReadFile("AttributeType.json", "DataJson"));
            ...
            return View("~/Areas/Admin/Views/ContentDataJson/ListAttributeType.cshtml", model);
        }
