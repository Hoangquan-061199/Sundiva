...
{
    public class ContentDataJsonAddressStartTourController : BaseController
    {
        private readonly ModuleAdminDa _moduleAdminDa;
        public ContentDataJsonAddressStartTourController()
        {
        ...
        public IActionResult Index()
        {
            ...
            Module module = _moduleAdminDa.GetTag("ContentDataJsonAddressStartTour");
        ...
        {
            ViewBag.Type = "ContentDataJsonAddressStart";
            SearchModel seach = new();
            TryUpdateModelAsync(seach);
            seach.keyword = Utility.ValidString(seach.keyword, "", true);
            List<CommonJsonAdmin> listItem = JsonConvert.DeserializeObject<List<CommonJsonAdmin>>(ReadFile("AddressStart.json", "DataJson"));
            ...
            return View("~/Areas/Admin/Views/ContentDataJsonAddressStartTour/ListItems.cshtml", model);
        }
        ...
        public ActionResult AjaxForm()
        {
            ...
            {
                List<CommonJsonAdmin> list = JsonConvert.DeserializeObject<List<CommonJsonAdmin>>(ReadFile("AddressStart.json", "DataJson"));
            ...
            {
                return View("~/Areas/Admin/Views/ContentDataJsonAddressStartTour/AjaxForm.cshtml", model);
            }
            return View(model);
        }
        [HttpPost]
            ...
            switch (action.Do)
            {
                case ActionType.Add:
                    try
                    {
                        ...
                        List<CommonJsonAdmin> listCommon = JsonConvert.DeserializeObject<List<CommonJsonAdmin>>(ReadFile("AddressStart.json", "DataJson"));
                        if (listCommon == null)
                        {
                        ...
                        Common.CreateFileJson(0, listCommon, "AddressStart", "DataJson");
