...
namespace Website.Areas.Admin.Controllers
{
    public class ContactUsController : BaseController
    {
        ...
        public IActionResult Index()
        {
            ...
            Module module = _moduleAdminDa.GetTag("ContactUs");
        ...
        public ActionResult ProcessExportFile()
        {
            ...
            string fileName = string.Format("lien-he_{0}.xlsx", DateTime.Now.ToString("yyyy-MM-dd-HH-mm-ss"));
        ...
        public virtual void ExportReportToExcel(string filePath, List<ContactUsAdmin> report)
        {
            ...
            {
                ExcelWorksheet worksheet = xlPackage.Workbook.Worksheets.Add("LienHe");
                ...
                xlPackage.Workbook.Properties.Company = "Liên hệ";
                xlPackage.Save();
            }
        }
    }
