...
{
    public class ContentDataJsonController : BaseController
    {
        private readonly ModuleAdminDa _moduleAdminDa;
        public ContentDataJsonController()
        {
        ...
        public IActionResult Index()
        {
            ...
            Module module = _moduleAdminDa.GetTag("ContentDataJson");
        ...
        {
            ViewBag.Type = "ReceiverMail";
            SearchModel seach = new();
            TryUpdateModelAsync(seach);
            seach.keyword = Utility.ValidString(seach.keyword, "", true);
            List<CommonJsonAdmin> listItem = JsonConvert.DeserializeObject<List<CommonJsonAdmin>>(ReadFile("ReceiverMail.json", "DataJson"));
            ...
            return View("~/Areas/Admin/Views/ContentDataJson/ListReceiverMail.cshtml", model);
        }
        ...
        {
            string type = Request.Query["TypeJson"].ToString();
            ...
            {
                List<CommonJsonAdmin> list = JsonConvert.DeserializeObject<List<CommonJsonAdmin>>(ReadFile(type + ".json","DataJson"));
            ...
            {
                return View("~/Areas/Admin/Views/ContentDataJson/AjaxForm" + type + ".cshtml", model);
            }
            return View(model);
        }
        [HttpPost]
            ...
            switch (action.Do)
            {
                case ActionType.Add:
                    try
                    {
                        ...
                        List<CommonJsonAdmin> listCommon = JsonConvert.DeserializeObject<List<CommonJsonAdmin>>(ReadFile(Request.Form["TypeJson"] + ".json", "DataJson"));
                        if (listCommon == null)
                        {
                        ...
                        Common.CreateFileJson(0, listCommon, Request.Form["TypeJson"], "DataJson");
                ...
                case ActionType.Edit:
                    try
                    {
                        ...
                        if (obj != null)
                        {
                            ...
                            AddLogAdmin(Request.Path, "Sửa Dữ liệu Json", "Actions-Edit");
                            msg = new JsonMessage
                            {
                                Errors = false,
                ...
                case ActionType.Delete:
                    ...
                    try
                    {
                        ...
                        if (obj != null)
                        {
                            ...
                            AddLogAdmin(Request.Path, "Xóa Dữ liệu Json", "Actions-Delete");
                            msg = new JsonMessage
                            {
                                Errors = false,
