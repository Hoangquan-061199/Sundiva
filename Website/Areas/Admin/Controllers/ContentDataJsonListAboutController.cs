...
{
    public class ContentDataJsonListAboutController : BaseController
    {
        private readonly ModuleAdminDa _moduleAdminDa;
        public ContentDataJsonListAboutController()
        {
        ...
        public IActionResult Index()
        {
            ...
            Module module = _moduleAdminDa.GetTag("ContentDataJsonListAbout");
        ...
        {
            ViewBag.Type = "ListAboutJson";
            SearchModel seach = new();
            TryUpdateModelAsync(seach);
            seach.keyword = Utility.ValidString(seach.keyword, "", true);
            List<CommonJsonAdmin> listItem = JsonConvert.DeserializeObject<List<CommonJsonAdmin>>(ReadFile("ListAboutJson.json", "DataJson"));
            ...
            return View("~/Areas/Admin/Views/ContentDataJsonListAbout/ListItems.cshtml", model);
        }
        ...
        public ActionResult AjaxForm()
        {
            ...
            {
                List<CommonJsonAdmin> list = JsonConvert.DeserializeObject<List<CommonJsonAdmin>>(ReadFile("ListAboutJson.json", "DataJson"));
            ...
            {
                return View("~/Areas/Admin/Views/ContentDataJsonListAbout/AjaxForm.cshtml", model);
            }
            return View(model);
        }
        [HttpPost]
            ...
            switch (action.Do)
            {
                case ActionType.Add:
                    try
                    {
                        ...
                        List<CommonJsonAdmin> listCommon = JsonConvert.DeserializeObject<List<CommonJsonAdmin>>(ReadFile("ListAboutJson.json", "DataJson"));
                        if (listCommon == null)
                        {
                        ...
                        Common.CreateFileJson(0, listCommon, "ListAboutJson", "DataJson");
                        AddLogEdit(Request.Path, "Add", obj.ID.ToString(), listCommon);
                        AddLogAdmin(Request.Path, "Thêm mới tiện nghi đầy đủ", "Actions-Add");
                        msg = new JsonMessage
                        {
                            Errors = false,
                ...
                case ActionType.Edit:
                    try
                    {
                        ...
                        if (obj != null)
                        {
                            ...
                            AddLogAdmin(Request.Path, "Sửa tiện nghi đầy đủ", "Actions-Edit");
                            msg = new JsonMessage
                            {
                                Errors = false,
                ...
                case ActionType.Delete:
                    ...
                    try
                    {
                        ...
                        if (obj != null)
                        {
                            ...
                            AddLogAdmin(Request.Path, "Xóa tiện nghi đầy đủ", "Actions-Delete");
                            msg = new JsonMessage
                            {
                                Errors = false,
