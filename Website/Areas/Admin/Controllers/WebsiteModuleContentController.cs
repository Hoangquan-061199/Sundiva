...
namespace Website.Areas.Admin.Controllers
{
    public class WebsiteModuleContentController : BaseController
    {
        ...
        public IActionResult Index()
        {
            ...
            Module module = _moduleAdminDa.GetTag("WebsiteModuleContent");
        ...
        public IActionResult ListItems()
        {
            ...
            string type = $"{StaticEnum.Product},{StaticEnum.Sale},{StaticEnum.Trademark}";
            string role = HttpContext.Session.GetString("WebAdminRole");
            string userId = HttpContext.Session.GetString("WebAdminUserID");
            string moduleIds = _websiteModuleDa.GetModuleIds(role, userId);
            seach.ModuleIds = moduleIds;
            List<WebsiteModuleAdmin> ltsSourceModule = _websiteModuleDa.GetAdminAllFilter(seach, Lang(), type, string.Empty);            
        ...
        public ActionResult AjaxForm()
        {
            ...
            if (action.Do == ActionType.Edit)
            {
                ...
                if (!string.IsNullOrEmpty(websiteModule.Faqs))
                {
                    model.ListFag = _websiteContentDa.GetListByArrId(websiteModule.Faqs);
                }
            ...
            ViewBag.TypeModule = "News";
            return View("~/Areas/Admin/Views/WebsiteModule/AjaxFormNews.cshtml", model);
        }
    }
}
