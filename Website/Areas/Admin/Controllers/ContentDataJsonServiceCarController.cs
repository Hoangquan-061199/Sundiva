...
{
    public class ContentDataJsonServiceCarController : BaseController
    {
        private readonly ModuleAdminDa _moduleAdminDa;
        public ContentDataJsonServiceCarController()
        {
        ...
        public IActionResult Index()
        {
            ...
            Module module = _moduleAdminDa.GetTag("ContentDataJsonServiceCar");
        ...
        {
            ViewBag.Type = "ServiceCarJson";
            SearchModel seach = new();
            TryUpdateModelAsync(seach);
            seach.keyword = Utility.ValidString(seach.keyword, "", true);
            List<CommonJsonAdmin> listItem = JsonConvert.DeserializeObject<List<CommonJsonAdmin>>(ReadFile("ServiceCarJson.json", "DataJson"));
            ...
            return View("~/Areas/Admin/Views/ContentDataJsonServiceCar/ListItems.cshtml", model);
        }
        ...
        public ActionResult AjaxForm()
        {
            ...
            {
                List<CommonJsonAdmin> list = JsonConvert.DeserializeObject<List<CommonJsonAdmin>>(ReadFile("ServiceCarJson.json", "DataJson"));
            ...
            {
                return View("~/Areas/Admin/Views/ContentDataJsonServiceCar/AjaxForm.cshtml", model);
            }
            return View(model);
        }
        [HttpPost]
            ...
            switch (action.Do)
            {
                case ActionType.Add:
                    try
                    {
                        ...
                        List<CommonJsonAdmin> listCommon = JsonConvert.DeserializeObject<List<CommonJsonAdmin>>(ReadFile("ServiceCarJson.json", "DataJson"));
                        if (listCommon == null)
                        {
                        ...
                        Common.CreateFileJson(0, listCommon, "ServiceCarJson", "DataJson");
                        AddLogEdit(Request.Path, "Add", obj.ID.ToString(), listCommon);
                        AddLogAdmin(Request.Path, "Thêm mới dịch vụ xe", "Actions-Add");
                        msg = new JsonMessage
                        {
                            Errors = false,
                ...
                case ActionType.Edit:
                    try
                    {
                        ...
                        if (obj != null)
                        {
                            ...
                            AddLogAdmin(Request.Path, "Sửa dịch vụ xe", "Actions-Edit");
                            msg = new JsonMessage
                            {
                                Errors = false,
                ...
                case ActionType.Delete:
                    ...
                    try
                    {
                        ...
                        if (obj != null)
                        {
                            ...
                            AddLogAdmin(Request.Path, "Xóa dịch vụ xe", "Actions-Delete");
                            msg = new JsonMessage
                            {
                                Errors = false,
